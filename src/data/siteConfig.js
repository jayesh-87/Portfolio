// Import screenshots as modules (processed assets, like the profile image)
// Move images to /src/assets/screenshots/ in your repo
import correlationheatmap from '../assets/screenshots/correlationheatmap.png';
import smartparking1 from '../assets/screenshots/smartparking1.png';
import smartparking2 from '../assets/screenshots/smartparking2.png';
import aitrading1 from '../assets/screenshots/aitrading1.png';
import aitrading2 from '../assets/screenshots/aitrading2.png';
// import courtScraper1 from '../assets/screenshots/court-scraper-1.png';
// import courtScraper2 from '../assets/screenshots/court-scraper-2.png';
// import courtScraper3 from '../assets/screenshots/court-scraper-3.png';
  ...
  projects: [
    {
      ...
      images: [correlationheatmap]  // Now imported (processed asset)
    },
    {
      id: 2,
      ...
      images: [smartparking1, smartparking2]  // Now imported
    },
    {
      id: 3,
      ...
      images: [aitrading1, aitrading2]  // Now imported
    }
    // {
    //   id: 4,
    ...
    //   images: [courtScraper1, courtScraper2, courtScraper3]  // Now imported
    // }
  ],
  skills: [
    {
